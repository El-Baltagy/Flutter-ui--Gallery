...
import '../../shared/widget/app_theme.dart';
                            ...
                            children: List<Widget>.generate(
                              ...
                              (int index) {
                                ...
                                return HomeListView(
                                  ...
                                  callBack: () {
                                   GoPage.push(context, path: Scaffold(
                                     appBar: PreferredSize(

                                         preferredSize: Size(double.maxFinite, AppBar().preferredSize.height*1.5),
                                         child: const BuildAppBar()

                                     ),
                                     body: homeList[index].navigateScreen,
                                   ));
                                  },
                                );
                              },
